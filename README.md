...
The Move_Base server takes a non-negligible amount of time to notify the successful reaching of a point.  
Here, for example, the robot was asked to reach the very point it was located.  
